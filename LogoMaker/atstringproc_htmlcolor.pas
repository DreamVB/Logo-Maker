//This project using this unit for converting the color from html and TColor for my Logo Maker.
//Original link

//https://wiki.lazarus.freepascal.org/Convert_color_to/from_HTML/fr
